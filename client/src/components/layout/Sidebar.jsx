      ...
      case 'Enseignant':
        return [
          { name: 'Accueil', path: '/enseignant', icon: 'home' },
          {
            ...
            path: '/enseignant/requetes-attente',
            icon: 'clock',
          },
          {
            name: 'Étudiants Attribués',
            path: '/enseignant/etudiants-attribues',
            icon: 'users',
          },
          ...
          <div className="p-4 border-t border-slate-200">
            ...
            >
              <p className="text-xs text-slate-500 text-center">
                Gestion de projet pédagogique v1.0
              </p>
            </div>
          </div>
        </div>
